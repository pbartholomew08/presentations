...
\label{sec:org3c6523b}

\begin{frame}[label={sec:org6325c62}]{Gravity Currents}
\begin{center}
\includegraphics[width=\columnwidth]{./figures/intro-grav-curr.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:org9ffcf78}]{Gravity Currents is 2D valid?}
\begin{itemize}
...
\end{equation}
\begin{itemize}
\item However literature claims 2D simulations sufficient for non-Boussinesq
\end{itemize}
\end{frame}

\section{Numerical Methods}
\label{sec:org30b2d66}
