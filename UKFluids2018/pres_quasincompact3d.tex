...
%% Version: 
%% Package-Requires: ()
%% Last-Updated: Tue Aug 28 17:00:30 2018 (+0100)
%%           By: Paul Bartholomew
%%     Update #: 610
%% URL: 
%% Doc URL: 
...
\begin{frame}
  ...
  \begin{itemize}
  \item Advance density/temperature in time and compute $\vdiv{\vvelocity}^{k+1}$
    \begin{equation*}
...
\begin{frame}
  ...
  \item Like incompressible approach, take divergence of momentum directly
    \begin{equation*}
      ...
      \right)
    \end{equation*}
  \item[\textcolor{blue}{\textbf{+}}] Constant coefficient Poisson equation: direct solvers
    available 
...
\begin{frame}
  ...
  \item \textbf{Constant coefficient}
    ...
    \item[\textcolor{red}{\textbf{--}}] Only applicable for density ratios $< \orderof{3}-\orderof{5}$
    \end{itemize}
    ...
    \begin{column}{0.5\textwidth}
      \begin{figure}[c]
        ...
        \begin{subfigure}[b]{\columnwidth}
          ...
          \caption{$t=10$}
        \end{subfigure}
        \caption{Lock-exchange $\dfrac{\rho_2}{\rho_1} = 0.998$}\label{fig:lock-exch}
      \end{figure}
    \end{column}
  \end{columns}
\end{frame}
    ...
    \begin{column}{0.5\textwidth}
      \begin{figure}[c]
        ...
        \begin{subfigure}[b]{\columnwidth}
          ...
          \caption{$t=10$}
        \end{subfigure}
        \caption{Lock-exchange $\dfrac{\rho_2}{\rho_1} = 0.92$}\label{fig:lock-exch}
      \end{figure}
    \end{column}
  \end{columns}
\end{frame}
    ...
    \begin{column}{0.5\textwidth}
      \begin{figure}[c]
        ...
        \begin{subfigure}[b]{\columnwidth}
          ...
          \caption{$t=10$}
        \end{subfigure}
        \caption{Lock-exchange $\dfrac{\rho_2}{\rho_1} = 0.2$}\label{fig:lock-exch}
      \end{figure}
    \end{column}
  \end{columns}
\end{frame}
